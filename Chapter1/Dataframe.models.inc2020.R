...
mean(cater_habitat$date) # 146.77
sd(cater_habitat$date) # 14.04305
...
save(AbundVar20, file = "~/Documents/Models/AbundVar20.RData")
#load("~/Documents/Models/AbundVar20.RData") 
...
save(TTHA20, file = "~/Documents/Models/TTHA20.RData")
#load("~/Documents/Models/TTHA20.RData")
...
CurveShape20<- MCMCglmm(caterpillars~datescaled+I(datescaled^2)+I(datescaled^3), random=~us(1+datescaled+I(datescaled^2)):siteyear+recorder+siteday+treeID, family="poisson", data=cater_habitat, prior=prior, nitt=2000000, burnin=50000, thin=50)
save(CurveShape20, file = "~/Documents/Models/CurveShape20.RData")
#load("~/Documents/Models/CurveShape20.RData")
...
save(ATTC20, file = "~/Documents/Models/ATTC20.RData")
#load("~/Documents/Models/ATTC20.RData")
...
Mass20<- MCMCglmm(cbind(logmpc1, logmpc2)~ datescaled + I(datescaled^2), 
                        ...
                        family="cengaussian", data=cater_habitat_1720, prior=prior3, pr=TRUE,nitt=5500000, burnin=100000, thin=350)
save(Mass20, file = "~/Documents/Models/Mass20.RData")
#load("~/Documents/Models/Mass20.RData")